            ...
            >
              <div className="flex flex-col justify-center">
                {/* <img
                  ...
                  alt="Hero"
                /> */}
                <div className="w-full max-w-sm mx-auto mt-6 bg-transparent border rounded-md border-yellow focus-within:border-yellow focus-within:ring focus-within:ring-yellow focus-within:ring-opacity-40">
                  <form className="flex flex-col md:flex-row">
                    <input
                      type="email"
                      placeholder="Enter your email address"
                      className="flex-1 h-10 px-4 py-2 m-1 text-gray-700 placeholder-hero bg-transparent border-none appearance-none  focus:outline-none focus:placeholder-transparent focus:ring-0"
                    />

                    <button
                      type="button"
                      className="h-10 px-4 py-2 m-1 text-hero transition-colors duration-200 transform bg-green rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400"
                    >
                      Join the waitlist
                    </button>
                  </form>
