          ...
          <div>
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold font-Lexend bg-yellow tracking-wide text-hero transition duration-200 rounded shadow-md md:w-auto hover:bg-green cus:shadow-outline focus:outline-none"
              >
                Join the waitlist
              </a>
            </div>
