        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1
              ...
              data-aos="zoom-y-out"
            >
              Because small teams deserve all the{" "}
            ...
            <div className="max-w-3xl mx-auto">
              <p
                className="text-xl text-white mb-8 font-average"
                data-aos="zoom-y-out"
                data-aos-delay="150"
              >
              ...
              >
                ...
                <div>
                  <a
                    className="btn text-blue bg-green font-Lexend hover:bg-gray-800 hover:text-white w-full sm:w-auto sm:ml-4"
                    href="#0"
                  >
                    Learn more
                  </a>
