  ...
  return (
    <section className="relative">
      ...
      <div
        ...
        aria-hidden="true"
      ></div>
      <div className="py-12 md:py-20 border-t border-gray-200"></div>

      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1 mb-4 text-hero font-Lexend">Small but mighty</h1>
            <p className="text-xl text-gray-900 font-average-400">
              We are here to help empower your team. With a variety of benefits,
              show your team you care by joining the Frigeify network today.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              >
                <g fill="none" fillRule="evenodd">
                  ...
                  <g strokeWidth="2">
                    <path
                      className="stroke-current text-hero"
                      d="M34.514 35.429l2.057 2.285h8M20.571 26.286h5.715l2.057 2.285"
                    />
                    <path
                      className="stroke-current text-green"
              ...
              <h4 className="text-xl font-bold font-Lexend text-hero leading-snug tracking-tight mb-1">
                Retention
              </h4>
              <p className="text-gray-600 font-aven-400 text-center">
                Show your team that you value their time. Add your team to the
                Frigeify network and give your team a boost
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl text-hero font-bold font-Lexend leading-snug tracking-tight mb-1">
                Recruiting
              </h4>
              <p className="text-gray-600 font-aven-400 text-center">
                Recruit talent with the confidence that you're giving them the
                tools to create a positive work-life balance
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 font-aven-400 text-center">
                Relax, kick your feet up. Time to enjoy some Fringeify benefits.
                Benefits for small teams outside of work
              </p>
            </div>
