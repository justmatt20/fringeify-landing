      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-12">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4 text-green-400">
          ...
          <div className="flex flex-col items-center pt-12 md:pt-16">
            <div className="relative">
              ...
              >
                <g className="fill-current text-yellow opacity-75">
              ...
              >
                <defs>
                  ...
                  <linearGradient
                    ...
                    id="world-ill-f"
                  >
                    <stop stopColor="yellow" stopOpacity="0" offset="0%" />
                    <stop
                      stopColor="yellow"
                      stopOpacity=".88"
                      offset="52.449%"
                    />
                    <stop stopColor="yellow" stopOpacity="0" offset="100%" />
                  </linearGradient>
                </defs>
                <g
                ...
                >
                  ...
                  />
                  <use fill="hero" xlinkHref="#world-ill-b" />
                  <use
                    fill="hero"
                    filter="url(#world-ill-c)"
                    xlinkHref="#world-ill-d"
                  />
                  <use fill="hero" xlinkHref="#world-ill-d" />
                  <ellipse
                    fillOpacity=".32"
                    fill="hero"
                    cx="293"
                  ...
                  <ellipse
                    ...
                    ry="1.947"
                  />
                  <ellipse fill="hero" cx="29" cy="114.072" rx="2" ry="1.947" />
                  <path
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g className="fill-current text-green-400">
                  <circle
