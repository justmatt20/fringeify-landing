      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 ">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-Lexend mb-4 text-green">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute inset-0 font-average-400">
                <div className="absolute font-medium px-4 py-2 text-white  bg-gradient-to-tr from-green to-indigo-400   rounded-full inline-flex items-center justify-center tags-animation mt-28">
                  Custom Support
                </div>
                <div className="absolute font-medium px-4 py-2 text-white bg-gradient-to-tr from-yellow to-teal-400 dark:bg-teal-500   rounded-full inline-flex items-center justify-center tags-animation tags-1 mt-72">
                  Components
                </div>
                <div className="absolute font-medium px-4 py-2 text-white  bg-gradient-to-tr from-hero to-pink-400   rounded-full inline-flex items-center justify-center tags-animation tags-2 mt-40">
                  Items
                </div>
