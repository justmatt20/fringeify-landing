      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1 mb-4 text-hero font-Lexend">
              Joining Fringeify is simple
            </h1>
            <p className="text-xl text-gray-600 font-average-400">
              Small but mighty, we are here to help empower your team. With a
              variety of benefits, show your teams you care by joining the
              Frigeify network today.
            </p>
          </div>
