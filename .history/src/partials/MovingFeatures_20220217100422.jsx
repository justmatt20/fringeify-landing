          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute inset-0">
                <div className="absolute font-medium px-4 py-2 text-white  bg-gradient-to-tr from-indigo-500 to-indigo-400 dark:bg-indigo-500  rounded-full inline-flex items-center justify-center tags-animation mt-28">
                  Custom Support
                </div>
                <div className="absolute font-medium px-4 py-2 text-white bg-gradient-to-tr from-teal-500 to-teal-400 dark:bg-teal-500 dark:from-transparent  rounded-full inline-flex items-center justify-center tags-animation tags-1 mt-72">
                  Components
                </div>
