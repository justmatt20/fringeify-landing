      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4 text-green font-Lexend">
              Benefits that have no borders
            </h1>
            <p className="text-xl text-gray-600 font-average-400">
              Your team is everywhere. Show them you value their time outside of
              work by providing them with extra fringe benefits that don't break
              your budget.
            </p>
          </div>

          {/* World illustration */}
          <div className="flex flex-col items-center pt-12 md:pt-16 mb-16">
            <div className="relative">
              ...
              >
                <g className="fill-current text-hero opacity-75">
              ...
              >
                <defs>
                  ...
                  <linearGradient
                    ...
                    id="world-ill-f"
                  >
                    <stop stopColor="#0fbe7b" stopOpacity="0" offset="0%" />
                    <stop
                      stopColor="#0fbe7b"
                      stopOpacity=".88"
                      offset="52.449%"
                    />
                    <stop stopColor="#0fbe7b" stopOpacity="0" offset="100%" />
                  </linearGradient>
                </defs>
                <g
                ...
                >
                  ...
                  />
                  <use fill="#0fbe7b" xlinkHref="#world-ill-b" />
                  <use
                    fill="#0fbe7b"
                    filter="url(#world-ill-c)"
                    xlinkHref="#world-ill-d"
                  />
                  <use fill="#0fbe7b" xlinkHref="#world-ill-d" />
                  <ellipse
                    fillOpacity=".32"
                    fill="#0fbe7b"
                    cx="293"
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g className="fill-current text-yellow">
                  <circle
