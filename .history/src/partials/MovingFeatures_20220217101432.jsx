          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute inset-0 font-average-400">
                ...
                <div className="absolute font-medium px-4 py-2 text-white  bg-gradient-to-tr from-hero to-green  rounded-full inline-flex items-center justify-center tags-animation tags-2 mt-40">
                  Items
                </div>
