        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          >
            <img
              ...
              src={require("../images/about-grid-01.jpg").default}
              width="360"
              height="270"
              alt="About grid 01"
              data-aos="fade-down"
            ...
            <img
              ...
              src={require("../images/about-grid-02.jpg").default}
              width="270"
              height="270"
              alt="About grid 02"
              data-aos="fade-down"
            ...
            <img
              ...
              src={require("../images/about-grid-03.jpg").default}
              width="450"
              height="270"
              alt="About grid 03"
              data-aos="fade-down"
            ...
            <img
              className="col-span-3"
              src={require("../images/about-grid-04.jpg").default}
              width="270"
              height="270"
              alt="About grid 04"
              data-aos="fade-down"
            ...
            <img
              className="col-span-5"
              src={require("../images/about-grid-05.jpg").default}
              width="450"
              height="270"
              alt="About grid 05"
              data-aos="fade-down"
            ...
            <img
              className="col-span-4"
              src={require("../images/about-grid-06.jpg").default}
              width="360"
              height="270"
              alt="About grid 06"
              data-aos="fade-down"
