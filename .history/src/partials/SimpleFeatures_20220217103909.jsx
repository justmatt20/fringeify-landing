        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-900 font-average-400">
              Studies show that employees are more likely to stay with their
              current employer when they are offered additional benefits.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              <div
                aria-hidden="true"
                className="absolute h-0.5 bg-hero   hidden md:block"
                style={{
                  width: "calc(100% - 96px)",
                  left: "calc(50% + 64px)",
                  top: "40px",
            ...
            <div className="relative flex flex-col items-center">
              <div
                aria-hidden="true"
                className="absolute h-0.5 bg-gray-900   hidden md:block"
                style={{
                  width: "calc(100% - 96px)",
                  left: "calc(50% + 64px)",
                  top: "40px",
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-average-400 text-gray-900"></div>
            </div>
