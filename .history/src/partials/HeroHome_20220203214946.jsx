            ...
            >
              <div className="flex flex-col justify-center">
                {/* <img
                  ...
                  alt="Hero"
                /> */}
                <div className="w-full max-w-sm mx-auto bg-transparent border rounded-md border-yellow border-r-4 focus-within:border-yellow focus-within:ring focus-within:ring-yellow focus-within:ring-opacity-40">
