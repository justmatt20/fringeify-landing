            ...
            >
              <div className="flex flex-col justify-center">
                {/* <img
                  ...
                  alt="Hero"
                /> */}
                <div className="w-full max-w-sm bg-transparent border rounded-md border-yellow border-r-2 focus-within:border-yellow focus-within:ring focus-within:ring-yellow focus-within:ring-opacity-40">
