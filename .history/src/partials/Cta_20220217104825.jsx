    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 my-16">
        <div className="pb-12 md:pb-20">
          {/* CTA box */}
          <div
            className="bg-hero rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl"
            data-aos="zoom-y-out"
          >
            <div className="flex flex-col lg:flex-row justify-between items-center ">
              {/* CTA content */}
              <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                <h3 className="h3 text-green mb-2 font-Lexend">
                  Join the waitlist!
                </h3>
                <p className="text-white text-lg opacity-75 font-average-400">
