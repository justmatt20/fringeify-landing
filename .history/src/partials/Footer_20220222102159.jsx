...
import logo from "../images/FRINGEIFY.svg";
  ...
  return (
    <footer className="bg-hero">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-1 gap-4 py-2 md:py-12 border-t border-gray-200">
          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm text-yellow">
              <a
                href="https://educated-hyacinth-48e.notion.site/Fringeify-White-Paper-3bf6db02364049b7a93f733d58dec73c"
                className="text-yellow hover:text-gray-900 hover:underline transition duration-150 ease-in-out"
              >
                White Paper
              </a>{" "}
              ·{" "}
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a
                href="https://twitter.com/fringeify"
                className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-green hover:bg-yellow rounded-full shadow transition duration-150 ease-in-out"
                aria-label="Twitter"
              >
                <svg
          ...
          {/* Copyrights note */}
          <div className="text-sm text-yellow mr-4">
            &copy; 2022 Fringeify. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
