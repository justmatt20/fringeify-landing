            ...
            >
              <div className="flex flex-col justify-center">
                {/* <img
                  ...
                  alt="Hero"
                /> */}
                <div className="w-full max-w-sm mx-auto mt-6 bg-transparent border rounded-md  focus-within:border-yellow focus-within:ring focus-within:ring-yellow focus-within:ring-opacity-40">
                  <form className="flex flex-col md:flex-row">
                    ...
                    <button
                      type="button"
                      className="h-10 px-4 py-2 m-1 text-white transition-colors duration-200 transform bg-green rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400"
                    >
                      Join the waitlist
                    </button>
                  </form>
