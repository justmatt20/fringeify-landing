        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div>
            ...
            >
              ...
              <a
                href="/"
                className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold font-Lexend bg-green tracking-wide text-hero transition duration-200 rounded shadow-md md:w-auto hover:text-green hover:bg-yellow cus:shadow-outline focus:outline-none"
              >
                Join the waitlist
              </a>
            </div>
